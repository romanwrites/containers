...
void TestConstructorsConst(std::multiset<int> const &m, ft::MultiSet<int> const &fm, TestRunner const &tr) {
  std::multiset<int> m2(m.begin(), m.end());
  ft::MultiSet<int> fm2(fm.begin(), fm.end());
  AssertEqual(fm2, m2, tr.hintMessage("range constructor const"));

  std::multiset<int> m3(m2.begin(), m2.end());
  ft::MultiSet<int> fm3(fm2.begin(), fm2.end());
...
void TestTestAssignationOperatorConst(std::multiset<int> const &m, ft::MultiSet<int> const &fm, TestRunner const &tr) {
  std::multiset<int> m2 = m;
  ft::MultiSet<int> fm2 = fm;
...
void TestConstIterator(std::multiset<int> const &m, ft::MultiSet<int> const &fm, TestRunner const &tr) {
  auto it = m.begin();
  auto fit = fm.begin();
...
void TestConstReverseIterator(std::multiset<int> const &m, ft::MultiSet<int> const &fm, TestRunner const &tr) {
  auto it = m.rbegin();
  auto fit = fm.rbegin();
...
void TestFindConst(std::multiset<int> const &m, ft::MultiSet<int> const &fm, TestRunner const &tr) {
...
void TestLowerBoundConst(std::multiset<int> const &m, ft::MultiSet<int> const &fm, TestRunner const &tr) {
...
void TestUpperBoundConst(std::multiset<int> const &m, ft::MultiSet<int> const &fm, TestRunner const &tr) {
...
void TestEqualRangeConst(std::multiset<int> const &m, ft::MultiSet<int> const &fm, TestRunner const &tr) {
...
void TestRelationalNonMemberOperatorsConst(std::multiset<int> const &m1,
                                           std::multiset<int> const &m2,
                                           ft::MultiSet<int> const &fm1,
                                           ft::MultiSet<int> const &fm2,
                                           TestRunner const &tr) {
...
void TestRelationalNonMemberOperatorsNonConst(std::multiset<int> &m1,
                                              std::multiset<int> &m2,
                                              ft::MultiSet<int> &fm1,
                                              ft::MultiSet<int> &fm2,
                                              TestRunner const &tr) {
