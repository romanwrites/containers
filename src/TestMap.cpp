...
void TestRelationalNonMemberOperatorsConst(std::map<int, int> const &m1,
                                           std::map<int, int> const &m2,
                                           ft::Map<int, int> const &fm1,
                                           ft::Map<int, int> const &fm2,
                                           TestRunner const &tr) {
...
void TestRelationalNonMemberOperatorsNonConst(std::map<int, int> &m1,
                                              std::map<int, int> &m2,
                                              ft::Map<int, int> &fm1,
                                              ft::Map<int, int> &fm2,
                                              TestRunner const &tr) {
