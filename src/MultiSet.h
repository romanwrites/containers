...
class MultiSet {
 ...
 private:
  ...
  //	------------------------------------- MultiSet CONSTRUCTORS AND COPLIEN -----------------------------------------
 public:
//  empty
  explicit MultiSet(const key_compare &comp = key_compare(),
               const allocator_type &alloc = allocator_type())
      : tree(new Tree(NOT_UNIQUE, comp, alloc)) {
  }
...
//  copy
  MultiSet(const MultiSet &x) : tree(new Tree(NOT_UNIQUE)) {
    operator=(x);
  }
...
//  range
 ...
 public:
  ...
  friend bool operator==(const MultiSet<T_friend, Compare_f, Alloc_f> &lhs,
                         const MultiSet<T_friend, Compare_f, Alloc_f> &rhs);
